function scene3() {
  ...
  rightItemNextScene(495, 290, 580, 345, 4);
  ...
  if (char02_panda_start.isActive) tri_selectSection(545, 415, 580, 445);

  if (!char02_panda_start.isActive) {
...
function scene4() {
  ...
  char02_panda_start.isActive = false;
  char02_panda_end.display();
